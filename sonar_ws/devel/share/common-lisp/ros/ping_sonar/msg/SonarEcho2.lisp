...
;//! \htmlinclude SonarEcho2.msg.html

(cl:defclass <SonarEcho2> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass SonarEcho2 (<SonarEcho2>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <SonarEcho2>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'SonarEcho2)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ping_sonar-msg:<SonarEcho2> is deprecated: use ping_sonar-msg:SonarEcho2 instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <SonarEcho2>))
...
(cl:defmethod angle-val ((m <SonarEcho2>))
...
(cl:defmethod gain-val ((m <SonarEcho2>))
...
(cl:defmethod number_of_samples-val ((m <SonarEcho2>))
...
(cl:defmethod transmit_frequency-val ((m <SonarEcho2>))
...
(cl:defmethod speed_of_sound-val ((m <SonarEcho2>))
...
(cl:defmethod range-val ((m <SonarEcho2>))
...
(cl:defmethod step_size-val ((m <SonarEcho2>))
...
(cl:defmethod intensities-val ((m <SonarEcho2>))
  ...
  (intensities m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <SonarEcho2>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SonarEcho2>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SonarEcho2>)))
  "Returns string type for a message object of type '<SonarEcho2>"
  "ping_sonar/SonarEcho2")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SonarEcho2)))
  "Returns string type for a message object of type 'SonarEcho2"
  "ping_sonar/SonarEcho2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SonarEcho2>)))
  "Returns md5sum for a message object of type '<SonarEcho2>"
  "6a12e1e3318526964d851d44262d11cc")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SonarEcho2)))
  "Returns md5sum for a message object of type 'SonarEcho2"
  "6a12e1e3318526964d851d44262d11cc")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<SonarEcho2>)))
  "Returns full string definition for message of type '<SonarEcho2>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'SonarEcho2)))
  "Returns full string definition for message of type 'SonarEcho2"
  (cl:format cl:nil "Header header            #header info~%float32 angle               # the measurement angle [rad]~%uint8 gain  # Sonar Gain~%uint16 number_of_samples ~%uint16 transmit_frequency # [kHz]~%uint16 speed_of_sound # [m/s]~%uint8 range      #  range value [m]~%uint8 step_size  #  steps for each measurement(from 1 to 10)~%uint8[] intensities    # intensity data [0-255].  This is the actual data received from the sonar~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <SonarEcho2>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <SonarEcho2>))
